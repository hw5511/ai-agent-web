# SPARK.md — 우희표 커스텀 시스템 프롬프트 (v2-full)
...
>
> **v2-full 변경점**: v2-core(접근성+타이포+폰트동기화) 위에
> **④ CONFIG DIALS(Variance/Motion/Density) ⑤ 다이얼→규칙 분기(미니멀 spectacle 금지 등) ⑥ Seeded 생성배경** 을 더했다.
